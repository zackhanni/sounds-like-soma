...
export const metadata = {
  title:
    "Professional Services | Sounds Like Soma | Philadelphia Recording Studio",
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-start max-w-3xl">
            ...
            <p className="text-xl text-[#FFFFF0]/80 mb-8">
              Comprehensive audio, video, and creative services for artists,
              bands, podcasters, and content creators in Philadelphia.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="mb-4">
                At Sounds Like Soma, we provide comprehensive audio and creative
                services to help artists, bands, podcasters, and content
                creators bring their vision to life. Our Philadelphia studios
                combine state-of-the-art equipment with experienced
                professionals to deliver exceptional results for projects of all
                sizes.
              </p>

              <p className="mb-4">
                From professional recording and mixing to video production and
                artist promotion, we offer end-to-end solutions that cover every
                aspect of content creation and distribution. Our team
                understands the technical requirements and creative nuances of
                different media, ensuring your project meets industry standards
                while standing out from the crowd.
              </p>

              <p className="mb-4">
                Located in the heart of Philadelphia&apos;s vibrant music scene,
                our studios provide a comfortable, inspiring environment for
                creativity to flourish. Whether you&apos;re recording your first
                demo, producing a podcast series, or creating content for your
                brand, our services are designed to help you achieve
                professional results within your budget.
              </p>

              <p>
                Explore our service categories to learn more about how we can
                help with your specific project, or contact us today to discuss
                your needs and schedule a studio tour.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-purple-900/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-[#FFFFF0]/80 max-w-2xl mx-auto mb-8">
            Contact us today to discuss your project, schedule a studio tour, or
